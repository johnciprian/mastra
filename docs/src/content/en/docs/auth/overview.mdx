...
<CardGrid>
  ...
  <CardGridItem
    ...
    description="Gate an API with your own provider, using @mastra/core/server"
  />

  <CardGridItem
    title="Write an Auth Provider"
    href="/docs/auth/write-a-provider"
    description="Publish a provider for the Factory, ending in a green conformance suite"
  />

  <CardGridItem
    title="Capability Interfaces"
    href="/reference/auth/capability-interfaces"
    description="Which interface unlocks which behavior, and which provider satisfies which"
  />

  <CardGridItem
    title="Provider Obligations"
    href="/docs/auth/provider-obligations"
    description="The four requirements a provider must satisfy beyond the interfaces"
  />
</CardGrid>
